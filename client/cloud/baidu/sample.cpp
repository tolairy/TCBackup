...
int main()
{
    ...
    char *ak = "F6a0680645eb65925df4cdedf1f0a804";//这里换成你的ak
    char *sk = "E47dfb4f4de3b46b8b4887c06bf7d485";//这里换成你的sk
    char bucket[130] = "cumulus";//这里换成你的Bucket名字
    ...
    opt.clear();
   // opt["Size"] = "1MB"; 
    ret = bcs->put_object(bucket, "/hustbackup/put_object_sample2", "/home/dataset/gcc_src_trace/gcc-4.0.0.trace", res);
    puts("");
